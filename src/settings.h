...
public:
    ...
    Attribute_<bool>          always_show_frame = {"always_show_frame", true};
    Attribute_<bool>          default_direction_external_only = {"default_direction_external_only", true};
    Attribute_<unsigned long> default_frame_layout = {"default_frame_layout", 0};
    Attribute_<bool>          focus_follows_mouse = {"focus_follows_mouse", true};
    ...
    Attribute_<bool>          raise_on_focus = {"raise_on_focus", true};
    Attribute_<bool>          raise_on_focus_temporarily = {"raise_on_focus_temporarily", true};
    Attribute_<bool>          raise_on_click = {"raise_on_click", true};
    Attribute_<bool>          gapless_grid = {"gapless_grid", true};
    Attribute_<bool>          smart_frame_surroundings = {"smart_frame_surroundings", true};
    Attribute_<bool>          smart_window_surroundings = {"smart_window_surroundings", true};
    Attribute_<int>           monitors_locked = {"monitors_locked", 0};
    Attribute_<bool>          auto_detect_monitors = {"auto_detect_monitors", true};
    Attribute_<int>           pseudotile_center_threshold = {"pseudotile_center_threshold", 10};
    Attribute_<bool>          update_dragged_clients = {"update_dragged_clients", true};
